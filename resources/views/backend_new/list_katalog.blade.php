    ...
    <div class="container-fluid relative animatedParent animateOnce">
        <div class="tab-content pb-3" id="v-pills-tabContent">
            ...
            <div class="tab-pane animated fadeInUpShort show active" id="v-pills-1">
                    ...
                    <div class="col-md-3">
                        <div class="counter-box white r-5 p-3">
                            <div class="p-4">
                                ...
                                <div class="counter-title">Total Katalog Product</div>
                                <h5 class="sc-counter mt-3"> {{$total_katalog}} </h5>
                            </div>
                ...
                <button class="btn btn-primary" style="margin-bottom: 20px" data-toggle="modal" data-target="#modaladd">KATALOG BARU</button>
                <div class="row">
        ...
        <div class="modal-content">
            <form id="formadd" method="POST"> @csrf
                <div class="modal-header" style="background-color: deepskyblue">
                    <h5 class="modal-title" id="modal_title_6" style="color: white">KATALOG BARU</h5>
                ...
                <div class="modal-body">
                    <div class="py-3 text-center">
                        ...
                        <div class="form-group">
                            <p>KATALOG</p>
                            <input type="text" name="katalog_name" class="form-control text-capitalize" placeholder="- INPUTKAN NAMA / JENIS KATALOG"
                                required>
                        </div>
            ...
            <div class="modal-content">
                <form id="formremove" method="POST"> @csrf
                    ...
                    <div class="modal-body">
                        <div class="py-3 text-center">
                            <i class="fa fa-exclamation-circle fa-4x"></i>
                            <h4 class="heading mt-4">Yakin akan menghapus Katalog ini ?</h4>
                            <p>Katalog Ini akan dihapus dari database, apabila terdapat product yang berhubungan dengan katalog ini maka katalog ini tidak dapat dihapus</p>
...
<script>
    $(document).ready(function() {
            var table = $('#example').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ route('page.katalog.backend') }}",
                columns: [{
                        "width":10,
                        "data": null,
                        "sortable": false,
